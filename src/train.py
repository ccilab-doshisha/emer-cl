...
import numpy as np
from dataset import load_va, load_vggish, save_split_seed
from evaluation import evaluation
from loss import CompositeLoss
from model import EMER_CL
from nptyping import NDArray
from tqdm import tqdm
from util import LinearCCA, batch_generator, get_now, parser, save_params
...
def train(
    ...
    with tqdm(range(params.epoch), ncols=ncols) as pbar:
        ...
        target_dir = os.path.join(
            os.environ["WORKDIR"], "src", "model", params.dataset, get_now()
        )
